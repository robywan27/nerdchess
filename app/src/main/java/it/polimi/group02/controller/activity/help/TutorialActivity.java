...
/**
 * This activity displays the tutorial explaining how this app works and how to play a game.
 */
public class TutorialActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PreferencesUtility.setBackground(this, findViewById(R.id.activity_tutorial));
    }
    ...
    */
    ...
    public void forthButtonClick(View view) {
        ...
        playGameSound(this, R.raw.button_pressed);
        Intent intent = new Intent(this, HelpActivity1.class);
        startActivity(intent);
        finish();
    }
}
