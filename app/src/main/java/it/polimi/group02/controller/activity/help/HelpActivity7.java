...
/**
 * This activity displays the seventh page of the game rules tutorial.
 */
public class HelpActivity7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_help_7);

        // set the background image
        PreferencesUtility.setBackground(this, findViewById(R.id.activity_help_7));
    }
    ...
    */
    ...
    public void forthButtonClick(View view) {
        ...
        playGameSound(this, R.raw.button_pressed);
        Intent intent = new Intent(this, HelpActivity8.class);
        startActivity(intent);
        finish();
    }
}
