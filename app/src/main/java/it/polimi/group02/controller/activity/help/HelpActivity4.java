...
/**
 * This activity displays the fourth page of the game rules tutorial.
 */
public class HelpActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PreferencesUtility.setBackground(this, findViewById(R.id.activity_help_4));
    }
    ...
    */
    ...
    public void forthButtonClick(View view) {
        ...
        playGameSound(this, R.raw.button_pressed);
        Intent intent = new Intent(this, HelpActivity5.class);
        startActivity(intent);
        finish();
    }
}
