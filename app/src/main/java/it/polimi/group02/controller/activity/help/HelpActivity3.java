...
/**
 * This activity displays the third page of the game rules tutorial.
 */
public class HelpActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PreferencesUtility.setBackground(this, findViewById(R.id.activity_help_3));
    }
    ...
    */
    ...
    public void forthButtonClick(View view) {
        ...
        playGameSound(this, R.raw.button_pressed);
        Intent intent = new Intent(this, HelpActivity4.class);
        startActivity(intent);
        finish();
    }
}
