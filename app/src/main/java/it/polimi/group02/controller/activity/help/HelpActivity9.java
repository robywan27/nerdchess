...
/**
 * This activity displays the ninth page of the game rules tutorial.
 */
public class HelpActivity9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_help_9);

        // set the background image
        PreferencesUtility.setBackground(this, findViewById(R.id.activity_help_9));
    }
