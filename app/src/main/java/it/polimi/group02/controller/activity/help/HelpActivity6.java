...
/**
 * This activity displays the sixth page of the game rules tutorial.
 */
public class HelpActivity6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_help_6);

        // set the background image
        PreferencesUtility.setBackground(this, findViewById(R.id.activity_help_6));
    }
    ...
    */
    ...
    public void forthButtonClick(View view) {
        ...
        playGameSound(this, R.raw.button_pressed);
        Intent intent = new Intent(this, HelpActivity7.class);
        startActivity(intent);
        finish();
    }
}
