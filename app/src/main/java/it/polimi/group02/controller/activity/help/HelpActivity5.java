...
/**
 * This activity displays the fifth page of the game rules tutorial.
 */
public class HelpActivity5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_help_5);

        // set the background image
        PreferencesUtility.setBackground(this, findViewById(R.id.activity_help_5));
    }
    ...
    */
    ...
    public void forthButtonClick(View view) {
        ...
        playGameSound(this, R.raw.button_pressed);
        Intent intent = new Intent(this, HelpActivity6.class);
        startActivity(intent);
        finish();
    }
}
