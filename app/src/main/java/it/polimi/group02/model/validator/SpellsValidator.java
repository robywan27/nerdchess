 ...
 *
 * This interface defines the behaviour a spell validator should abide by.
 */
public interface SpellsValidator {
    /**
     * This method ought to be implemented by any concrete implementation of a spell validator.
     * @return the outcome of the validation process: true means the spell shall be cast; false determines the invalidity of the spell.
     */
    boolean checkSpell();
}
